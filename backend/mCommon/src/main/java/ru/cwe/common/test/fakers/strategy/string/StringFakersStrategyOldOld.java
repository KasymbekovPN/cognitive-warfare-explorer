...
// TODO: 18.06.2023 del
public final class StringFakersStrategyOldOld implements FakersStrategyOld {
	private static final List<FakersStrategyOld> STRATEGIES = new ArrayList<FakersStrategyOld>(){{
		add(new SimpleStringFakersStrategyOldOld());
	}};
